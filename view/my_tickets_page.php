...
<div class="wrap">
    ...
    <h2 class="nav-tab-wrapper">
        <a href="?page=quip-support-my-tickets&tab=open" class="nav-tab <?php echo $active_tab == 'open' ? 'nav-tab-active' : ''; ?>"><?php _e('Open Tickets', 'quip-support'); ?></a>
        <a href="?page=quip-support-my-tickets&tab=closed" class="nav-tab <?php echo $active_tab == 'closed' ? 'nav-tab-active' : ''; ?>"><?php _e('Closed Tickets', 'quip-support'); ?></a>
    </h2>
    <div class="tab-content">
        <form id="searchTicketsForm" method="get" action="" style="padding-top: 10px;">
            <p class="search-box">
                <input type="hidden" name="page" value="quip-support-my-tickets"/>
